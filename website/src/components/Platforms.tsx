    ...
    },
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
          ...
          <path
            fill="#33d375"
            d="M43,19c0,2.209-1.791,4-4,4h-4c0-2.209-1.791-4-4-4c-1.195,0,0,0,4,0s4-1.791,4-4s-1.791-4-4-4h-4 c-2.209,0-4-1.791-4-4s1.791-4,4-4h4C41.209,7,43,8.791,43,11C43,13.209,43,16.791,43,19z"
          ></path>
          <path
            fill="#40c4ff"
          ...
          <path
            fill="#40c4ff"
            d="M19,4c2.209,0,4,1.791,4,4v4c-2.209,0-4,1.791-4,4c0,1.195,0,0,0-4s-1.791-4-4-4s-4,1.791-4,4v4 c0,2.209-1.791,4-4,4s-4-1.791-4-4v-4c0-2.209,1.791-4,4-4C9.209,8,12.791,4,15,4C17.209,4,19,4,19,4z"
          ></path>
          <path
            fill="#e91e63"
            d="M14,39c0,2.209,1.791,4,4,4s4-1.791,4-4c0-1.254,0-9.741,0-11c0-2.209-1.791-4-4-4s-4,1.791-4,4 C14,29.259,14,37.746,14,39z"
          ></path>
          <path
            fill="#e91e63"
            d="M4,28c0-2.209,1.791-4,4-4h4c0,2.209,1.791,4,4,4c1.195,0,0,0-4,0s-4,1.791-4,4s1.791,4,4,4h4 c2.209,0,4,1.791,4,4s-1.791,4-4,4h-4c-2.209,0-4-1.791-4-4C4,33.791,4,30.209,4,28z"
          ></path>
          <path
            fill="#ffc107"
            d="M39,33c2.209,0,4-1.791,4-4s-1.791-4-4-4c-1.254,0-9.741,0-11,0c-2.209,0-4,1.791-4,4s1.791,4,4,4 C29.259,33,37.746,33,39,33z"
          ></path>
          <path
            fill="#ffc107"
            d="M28,43c-2.209,0-4-1.791-4-4v-4c2.209,0,4-1.791,4-4c0-1.195,0,0,0,4s1.791,4,4,4s4-1.791,4-4v-4 c0-2.209,1.791-4,4-4s4,1.791,4,4v4c0,2.209-1.791,4-4,4c-2.209,0-5.791,4-8,4C30.209,43,28,43,28,43z"
          ></path>
        </svg>
      ),
    },
